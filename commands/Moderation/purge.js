...
module.exports.run = async (client, message, args) => {
  ...
  if (!message.guild.me.permissions.has('MANAGE_MESSAGES')) return message.channel.send(`${client.config.emojis.error}Je n'ai pas la permission de supprimer des messages.`);
