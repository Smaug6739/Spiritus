module.exports.run = (client, message, args) => {
    if (!message.guild.me.permissions.has('MANAGE_CHANNELS')) return message.channel.send(`${client.config.emojis.FALSE}Je n'ai pas la permission de modifier ce channel.`);
    ...
    channel.updateOverwrite(message.guild.roles.everyone, {
        ...
        .then(message.channel.send(`${client.config.emojis.TRUE}J'ai bien lock le channel ${channel}`))
        .catch(console.error);
