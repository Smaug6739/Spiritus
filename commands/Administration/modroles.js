...
module.exports.run = async (client, message, args, settings) => {
    ...
    if (args[0].toLowerCase() === 'add') {
        if (!message.member.permissions.has('ADMINISTRATOR')) return message.channel.send(`${client.config.emojis.error}Vous devez avoir la permission d'admin pour utiliser cette commande.`);
