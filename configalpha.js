module.exports = {
    PREFIX: "??",
    DBCONNECTION : "mongodb+srv://spiritus-alpha:OX5QILsPgUsoWQmn@spiritusdev.clucu.gcp.mongodb.net/test",
    TOKEN: "Njg5MjExODk5NzIzNjQ0OTI4.XwXxYQ.17wQFui1uwPWmY7IiDVZc1eYpLc",
    ...
    ERREURS:{
      WEBHOOKID : '730464342386147329',
      WEBHOOKTOKEN : 'OMxriQPdQ-XKKlTXJnI3b_auregFhqAVjYciRYltswB7v_Cnh_440QaCj0XwoWieKfH0'
    ...
    webhooks : {
      ...
      errors:{
        ID : '730464342386147329',
        TOKEN : 'OMxriQPdQ-XKKlTXJnI3b_auregFhqAVjYciRYltswB7v_Cnh_440QaCj0XwoWieKfH0',
      }
    }
